...
export default class FGUIGameView extends fgui.GComponent {
	...
	protected onConstruct():void {
		...
		this.UI_IMG_SIGN_READY_2 = <fgui.GImage>(this.getChildAt(10));
		this.UI_GROUP_PLAYER_2 = <fgui.GGroup>(this.getChildAt(11));
		this.UI_COMP_HEAD_1 = <fgui.GComponent>(this.getChildAt(13));
		this.UI_TXT_NICKNAME_1 = <fgui.GTextField>(this.getChildAt(14));
		this.UI_TXT_ID_1 = <fgui.GTextField>(this.getChildAt(15));
		this.UI_IMG_SIGN_READY_1 = <fgui.GImage>(this.getChildAt(16));
		this.UI_TXT_WINLOSE_1 = <fgui.GTextField>(this.getChildAt(17));
		this.UI_GROUP_PLAYER_1 = <fgui.GGroup>(this.getChildAt(18));
		this.UI_COMP_OUT_HEND_1 = <FGUICompHand>(this.getChildAt(19));
