...
export default class FGUIGameView extends fgui.GComponent {
	...
	protected onConstruct():void {
		...
		this.UI_BTN_READY = <fgui.GButton>(this.getChildAt(22));
		this.UI_BTN_READY.onClick(this.onBtnReady, this);
		this.UI_BTN_PAPER = <FGUIBtnSelect>(this.getChildAt(24));
		this.UI_BTN_PAPER.onClick(this.onBtnPaper, this);
		this.UI_BTN_ROCK = <FGUIBtnSelect>(this.getChildAt(25));
		this.UI_BTN_ROCK.onClick(this.onBtnRock, this);
		this.UI_BTN_SCISSORS = <FGUIBtnSelect>(this.getChildAt(26));
		this.UI_BTN_SCISSORS.onClick(this.onBtnScissors, this);
		this.UI_GROUP_SELECT = <fgui.GGroup>(this.getChildAt(27));
