...
export default class FGUIGameView extends fgui.GComponent {
	...
	protected onConstruct():void {
		...
		this.UI_TXT_NICKNAME_2 = <fgui.GTextField>(this.getChildAt(5));
		this.UI_TXT_ID_2 = <fgui.GTextField>(this.getChildAt(6));
		this.UI_COMP_OFFLINE = <FGUICompOffline>(this.getChildAt(7));
		this.UI_COMP_THINKING = <FGUICompThinkAct>(this.getChildAt(8));
		this.UI_IMG_SIGN_READY_2 = <fgui.GImage>(this.getChildAt(9));
		...
		this.UI_BTN_CONTINUE = <fgui.GButton>(this.getChildAt(21));
		this.UI_BTN_CONTINUE.onClick(this.onBtnContinue, this);
		this.UI_BTN_PAPER = <FGUIBtnSelect>(this.getChildAt(23));
		this.UI_BTN_PAPER.onClick(this.onBtnPaper, this);
		this.UI_BTN_ROCK = <FGUIBtnSelect>(this.getChildAt(24));
		this.UI_BTN_ROCK.onClick(this.onBtnRock, this);
		this.UI_BTN_SCISSORS = <FGUIBtnSelect>(this.getChildAt(25));
		this.UI_BTN_SCISSORS.onClick(this.onBtnScissors, this);
		this.UI_GROUP_SELECT = <fgui.GGroup>(this.getChildAt(26));
		this.UI_COMP_CLOCK = <FGUICompClock>(this.getChildAt(27));
		this.UI_COMP_GAME_START = <FGUICompGameStartAct>(this.getChildAt(28));
		this.UI_TXT_ROOMID = <fgui.GTextField>(this.getChildAt(30));
	}
	onBtnDisband():void{};
	onBtnBack():void{};
	onBtnSure():void{};
